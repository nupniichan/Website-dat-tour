...
const TourDetails = () => {
    ...
    if (!tour) {
        return <div className="text-center py-8">Đang tải thông tin tour...</div>;
    }
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="mb-8">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        <h1 className="text-3xl font-bold mb-4">{tour.TENTOUR}</h1>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                <div className="text-sm text-gray-500">Điểm khởi hành</div>
                                <div className="font-medium">{tour.KHOIHANH}</div>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <div className="font-medium">{tour.PHUONGTIENDICHUYEN}</div>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                ...
                                <div className="font-medium">{tour.SOVE} vé</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <div className="font-medium">{dayjs(tour.NGAYDI).format('DD/MM/YYYY')}</div>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                ...
                                <div className="font-medium">{dayjs(tour.NGAYVE).format('DD/MM/YYYY')}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <div className="space-y-4 mb-6">
                        <div className="flex justify-between items-center">
                            <span className="text-gray-600">Giá thông thường</span>
                            <span className="font-medium">{parseFloat(tour.GIA).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-gray-600">Số chỗ còn nhận</span>
            ...
            {/* Chi tiết lịch trình */}
            <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
                <h2 className="text-xl font-semibold mb-4">Chi tiết lịch trình</h2>
                {scheduleDetails.length > 0 ? (
                    <div className="space-y-6">
                        {scheduleDetails.map((detail, index) => (
                            <div key={index} className="border-l-4 border-orange-500 pl-4">
                                <div className="font-semibold mb-2">Ngày {index + 1}: {dayjs(detail.NGAY).format('DD/MM/YYYY')}</div>
                                ...
                                <div className="mb-2 font-medium">{detail.SUKIEN}</div>
                                <p className="text-gray-600">{detail.MOTA}</p>
                            </div>
                        ))}
                    </div>
                ) : (
                    <p className="text-gray-500">Chưa có chi tiết lịch trình.</p>
                )}
            </div>
        </div>
    );
