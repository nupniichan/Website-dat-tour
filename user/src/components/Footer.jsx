...
const Footer = () => {
    ...
    return (
        <footer
            ...
            <div className="text-gray-500 bg-white xl:max-w-4xl lg:max-w-3xl border-1 mx-auto my-16 rounded-3xl z-50 pt-8">
                {/* Footer's top */}
                <div className="py-2">
                    <div className="max-w-lg sm:mx-auto sm:text-center">
                        ...
                        <p className="leading-relaxed mt-2 text-[15px]">
                            Không chỉ đặt tour, chúng tôi còn tạo ra những trải
                            nghiệm cá nhân hóa trải nghiệm du lịch phù hợp với
                            mong muốn riêng của bạn. Của chúng tôi đội ngũ tận
                            tâm cam kết tìm kiếm sự hoàn hảo cuộc phiêu lưu dành
                            cho bạn, đảm bảo giá trị đặc biệt và kỷ niệm khó
                            quên.
                        </p>
                    </div>
                ...
                <div className="bg-[#f97316] text-white rounded-bl-3xl rounded-br-3xl ">
                    <div className="mt-8 items-center justify-between sm:flex px-6">
                        ...
                        <div className="mt-6 sm:mt-0">
                            <ul className="flex items-center space-x-5 scale-[65%] -mr-7">
                                <GithubLink />
                                <InstaLink />
                                <TwitterLink />
                                <FacebookLink />

                                {/* <li className="w-10 h-10 border rounded-2xl scale-75 flex items-center justify-center cursor-pointer">
                                    <div>
                                        <svg
